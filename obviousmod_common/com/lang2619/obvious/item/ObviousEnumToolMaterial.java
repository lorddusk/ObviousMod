...
public enum ObviousEnumToolMaterial
{
    OBVIOUS(3, 1561, 8.0F, 3, 10);
    ...
    private ObviousEnumToolMaterial(int par3, int par4, float par5, int par6, int par7)
    {
    ...
    public int getToolCraftingMaterial()
    {
        switch (this)
        {
            case OBVIOUS: return ModItems.obviousIngot.itemID;
