...
public class ObviousSword extends Item
{
    private int weaponDamage;
    private final ObviousEnumToolMaterial toolMaterial;
    
    public ObviousSword(int par1, ObviousEnumToolMaterial par2EnumToolMaterial)
    {
        super(par1);
